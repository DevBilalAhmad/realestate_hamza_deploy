...
const Page = () => {
  return (
    <div className='lg:mx-32 mx-5'>
      ...
      <div className='lg:flex lg:flex-row flex-col text-[#283618] items-center justify-center lg:mb-32 mb-[40px]'>
      ...
      <div className='lg:flex lg:flex-row flex flex-col-reverse text-[#283618] items-center justify-center lg:mb-32 mb-[40px]'>
      ...
      <div className='flex-1 items-center justify-center lg:my-20  '>
        ...
        <div className='text-white relative pt-5 pb-[100px]'>
        <Link href="/">
        <button class="bg-[#283618] hover:bg-[#d8dcbc] text-white font-light py-2 px-4 border border-[#283618] rounded">Explore rooms</button>
        </Link>
        </div>
      </div>
      <div className='flex-1'>
      <img src='/e5.jpeg'className='lg:w-[100%] pr-[20px] w-[100%] h-[100%] ' /> </div>
      </div>
      </div>
      <div className='lg:flex lg:flex-row text-[#283618] items-center justify-center lg:mb-32 mb-[40px]'>
      <div className='lg:flex lg:flex-row flex flex-col'>
      <div className='flex-1 '>
      <img src='/e6.jpeg'className='lg:w-[100%] pr-[20px] w-[100%] h-[100%] ' /> </div>
      <div className='flex-1 items-center justify-center lg:my-20  '>
        ...
        <div className='text-white relative pt-5 pb-[100px]'>
        <Link href="/">
        <button class="bg-[#283618] hover:bg-[#d8dcbc] text-white font-light py-2 px-4 border border-[#283618] rounded">Find your rooms</button>
        </Link>
        </div>
      </div>
      </div>
      ...
      <div className='flex-1 items-center justify-center lg:my-20  '>
        ...
        <div className='text-white relative pt-5 pb-[100px]'>
        <Link href="/">
        <button class="bg-[#283618] hover:bg-[#d8dcbc] text-white font-light py-2 px-4 border border-[#283618] rounded">Find my rooms</button>
        </Link>
        </div>
      </div>
      <div className='flex-1 '>
      <img src='/e7.png'className='lg:w-[100%] lg:pr-[20px] w-[100%] h-[100%] ' /> </div>
      </div>
      </div>
      <div className='lg:flex lg:flex-row flex flex-col text-[#283618] items-center justify-center lg:mb-32 mb-[40px]'>
      <div className='flex flex-row'>
      ...
      <div className='flex-1 items-center justify-center lg:my-20  '>
        ...
        <div className='text-white relative pt-5 pb-[100px]'>
        <Link href="/">
        <button class="bg-[#283618] hover:bg-[#d8dcbc] text-white font-light py-2 px-4 border border-[#283618] rounded">Find your Place</button>
        </Link>
        </div>
      </div>
      <div className='flex-1 '>
      <img src='/e7.png'className='lg:w-[100%] pr-[20px] w-[100%] h-[100%] ' /> </div>
      </div>
      </div>
      <div className='lg:flex lg:flex-row flex flex-col-reverse '>
        <div className='flex-1'>
            ...
            <div className='text-white relative pt-5 pb-[100px]'>
             <Link href="/">
             <button class="bg-[#283618] hover:bg-[#d8dcbc] text-white font-light py-2 px-4 border border-[#283618] rounded">I'm interested</button>
            </Link>
             </div>
        </div>
