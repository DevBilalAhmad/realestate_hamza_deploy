...
const Faq = () => {
  return (
    <div class="max-w-screen-xl mx-auto lg:px-5 bg-[#fefbf3] min-h-sceen">
      <div class="flex flex-col items-center">
        <h2 class="font-bold text-5xl mt-5 tracking-tight">FAQ</h2>
        <p class="bg-[#fefbf3] text-xl mt-3">Frequenty asked questions</p>
      </div>
      <div class="grid divide-y divide-neutral-200 max-w-xl mx-auto mt-8">
        <div class="py-5">
          <details class="group">
            ...
            <p class="bg-[#fefbf3] mt-3 group-open:animate-fadeIn">
