...
const Ensuit_monumental = () => {
  return (
    ...
    <div className='flex-1 lg:ml-24 pl-5'>
      ...
      <p className='my-5'>Rates from 1.520 €/month</p>
...
export default Ensuit_monumental