    ...
    <div class="flex bg-slate-300  rounded-lg shadow-lg overflow-hidden mx-auto my-auto max-w-sm lg:max-w-4xl">
          ...
          <div class="w-full p-8 lg:w-1/2">
              ...
              <a href="#" class="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                  ...
                  <h1 class="px-4 py-3 w-5/6 text-center text-gray-600 font-bold" onClick={googleSignIn}>Sign in with Google</h1>
              </a>
              ...
              <div class="mt-8">
                  <button class="bg-gray-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600" onClick={saveData}>Login</button>
              </div>
              <div class="mt-4 flex items-center justify-between">
                  <span class="border-b w-1/5 md:w-1/4"></span>
                  <Link href="/SignUp" class="text-xs text-gray-500 uppercase">or sign up</Link>
                  <span class="border-b w-1/5 md:w-1/4"></span>
              </div>
          </div>
      </div>
